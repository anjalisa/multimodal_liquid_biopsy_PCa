...
# selektiere Columns
metadata_all_reduced <- select(metadata_all, FASTQ_FILE, READ, LANE_NO, SAMPLE_NAME, ILSE_NO, PATIENT_ID, TISSUE_TYPE)
...
write_csv(metadata_all_final, file="/Users/riediger/Documents/Lab_work_DKFZ/Versuche/exp15_cfMeDIP-Seq_run4/sequencing/generalprocessing_nextflow/data/metadata_all.csv")
...
write_csv(metadata_all_wider, file="/Users/riediger/Documents/Lab_work_DKFZ/Versuche/exp15_cfMeDIP-Seq_run4/sequencing/generalprocessing_nextflow/data/metadata_all_wider.csv")
...
write_csv(metadata_all_wider_short, file="/Users/riediger/Documents/Lab_work_DKFZ/Versuche/exp15_cfMeDIP-Seq_run4/sequencing/generalprocessing_nextflow/data/metadata.csv")
